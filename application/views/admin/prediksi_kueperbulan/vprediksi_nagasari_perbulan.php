        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Hasil Prediksi Kue Per Bulan</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('Beranda');?>">Beranda</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo base_url('Prediksi');?>">Prediksi</a></li>
                        <li class="breadcrumb-item active">Hasil Prediksi Kue Per Bulan</li>
                    </ol>
                </div>
            </div>
            <!-- SELESAI BREAD CRUMB -->
                    ...
                    <div class="col-md-12">
                        <div class="card" style="margin:0%;">
                            <div class="card-title">
                                <h2 style="text-align: center;">Prediksi Kue Nagasari Per Bulan</h2>
                                <hr>
                            </div>
                            ...
                            <div class="card-body" style="padding:5%;">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url('PrediksiBulan');?>">April</a></li>
                                        <li><a href="<?php echo base_url('PrediksiBulan/prediksi_nagasari_mei');?>">Mei</a></li>
                                        <li><a href="<?php echo base_url('PrediksiBulan/prediksi_nagasari_juni');?>">Juni</a></li>
                                        <li><a href="<?php echo base_url('PrediksiBulan/prediksi_nagasari_juli');?>">Juli</a></li>
                                        <li><a href="<?php echo base_url('PrediksiBulan/prediksi_nagasari_agustus');?>">Agustus</a></li>
                                    </ul>
                                </div>
                               <!--  <div>
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <!-- <table class="table table-hover table-bordered"> -->
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                echo $tabelprediksi_nagasari_april;
                                            ?>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <!-- <table class="table table-hover table-bordered"> -->
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                echo $tabelprediksi_nagasari_mei;
                                            ?>
