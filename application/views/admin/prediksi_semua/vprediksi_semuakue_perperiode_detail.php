                                            ...
                                            <div class="table-responsive m-t-40">
                                                <table id="" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $graf_pen=[];?>
                                                        <?php $array_y =[];?>
                                                        <?php $newTotalPeriode = 0;?>
                                                        <?php $newResult = [];?>
                                                        <?php //looping jika ada tanggal yang lewat 
                                                        ...
                                                        $b   = ($totalXY - ($newTotalPeriode * number_format($rataRataX,2) * number_format($rataRataY,2))) / $pembagiB;
                                ...
                                <div class="tab-pane p-20" id="perhitungan" role="tabpanel">
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <p><b>DIKETAHUI :</b></p>
                                                <p>n = <?php echo $newTotalPeriode;  ?></p>
                                                ...
                                                <br>
                                                <p><b>PERHITUNGAN :</b></p>
                                                <p>Menghitung Ybar = Total y / n = <?php echo number_format($rataRataY,2);  ?> </p>
                                                <p>Menghitung Xbar = Total x / n = <?php echo number_format($rataRataX,2);  ?> </p>
