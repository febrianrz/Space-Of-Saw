                                                ...
                                                <div class="col-md-12">
                                                    <form class="form-inline" action="" method="get">
                                                      <div class="form-group">
                                                        <label for="email">Periode Awal:</label>
                                                        &nbsp;&nbsp;
                                                        <select class="form-control" name="start">
                                                            <?php for($i=1;$i<=$maxPeriode;$i++):?>
                                                                <option value="<?=$i;?>" <?=$start==$i?'selected':null;?>><?=$i;?></option>
                                                            <?php endfor;?>
                                                        </select>
                                                      </div>
                                                      <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="end">
                                                            <?php for($i=1;$i<=$maxPeriode;$i++):?>
                                                                <option value="<?=$i;?>" <?=$end==$i?'selected':null;?>><?=$i;?></option>
                                                            <?php endfor;?>
                                                        </select>
                                                      </div>
                                            ...
                                            <div class="table-responsive m-t-40">
                                                <table id="" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $graf_pen=[];?>
                                                        <?php $n = $maxPeriode;?>
                                                        <?php $exPrediksiItem = null;?>
                                                        <?php foreach($cakes as $cake):?>
                                                            <?php 
                                                            $prediksiItem = $this->Mprediksi->getSingleItemPrediksi($cake->id_produk,$start_date, $end_date,$no, $totalPeriode, $typeInterval);
                                                            if($no==1){
