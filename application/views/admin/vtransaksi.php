                        ...
                        <div class="card" style="margin:0%;">
                            ...
                            <div class="card-body" style="padding:5%;">
                                ...
                                <div class="card-title">
                                    <h2 style="text-align: center;">Tabel Data Penjualan</h2>
                                                ...
                                                $no=0;
                                                    ...
                                                    ?>
                                                        ...
                                                        <td style="text-align: left;">
                                                                ...
                                                                <a href="<?php echo base_url('Transaksi/hapus_transaksi/');?><?php echo $lihat->id;?>" onclick="return confirm('Apakah Anda Yakin Akan Menghapus Penjualan Ini?')" class="btn btn-danger btn-xs"><i class="fa fa-times"> Hapus Data</i></a>
                                                        </td>
                                            </tr>
                                            <?php
                                                    }
                                                ...
                                                {
                                                    echo "<br><h2>Data Tidak Ada ! </h2><br>";
                                                }
                                            ?>
