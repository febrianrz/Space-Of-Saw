...
<![endif]-->
   ...
   <!--  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>asset/css/dropmenu.css"> -->
...
<body class="fix-header">
            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.html">
                        ...
                        <!--This is dark logo text--><!-- <img src="<?php echo base_url(); ?>asset/plugins/images/admin-text.png" alt="home" class="dark-logo" /> --><!--This is light logo text--><!-- <img src="<?php echo base_url(); ?>asset/plugins/images/admin-text-dark.png" alt="home" class="light-logo" /> -->
                     </span> </a>
                </div>
                <!-- /Logo -->
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <!-- <li>
                        <a class="profile-pic" href="#"> <img src="<?php echo base_url(); ?>asset/plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">Steave</b></a>
                    </li> -->
                </ul>
            </div>
            <!-- /.navbar-header -->
    ...
    <!--Counter js -->
    <script src="<?php echo base_url(); ?>asset/plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
    <script src="<?php echo base_url(); ?>asset/plugins/bower_components/counterup/jquery.counterup.min.js"></script>
    <!-- chartist chart -->
    <script src="<?php echo base_url(); ?>asset/plugins/bower_components/chartist-js/dist/chartist.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.min.js"></script>
    <!-- Sparkline chart JavaScript -->
    <script src="<?php echo base_url(); ?>asset/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js"></script>
    <!-- Custom Theme JavaScript -->
    <script src="<?php echo base_url(); ?>asset/js/custom.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/js/dashboard1.js"></script>
    <script src="<?php echo base_url(); ?>asset/plugins/bower_components/toast-master/js/jquery.toast.js"></script>
