	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w" action="<?php echo base_url(); ?>Login/cekLogin" method="POST">
					<span class="login100-form-title p-b-32">
						<center>TOKO AYAS SNACK</center>
					</span>
					...
					<div class="container-login100-form-btn">
						<center><input type="submit" class="login100-form-btn" value="LOGIN"></center>
