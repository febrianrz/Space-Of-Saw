...
class PrediksiMinggu extends CI_Controller {
 ...
 //       		// echo $kueid['id_produk'];
	...
	public function index(){
		...
		$data['start_date'] 	= $this->input->get('start')?$this->Mprediksi->getTanggalByPeriode($this->input->get('start'),$data['intervalDays']):$this->Mprediksi->getFirstDate();
		$data['end_date'] 		= $this->input->get('end')?$this->Mprediksi->getTanggalByPeriode($this->input->get('end')+1,$data['intervalDays']):$this->Mprediksi->getLastDate();
		$data['start']			= $this->input->get('start')?$this->input->get('start'):1;	
